...
MANUAL_SECTIONS = [
    ("Getting Started", [
        ...
        ("table_row", "docflix-scale|Video Scaler"),
    ]),
    ...
    ("Tools", [
        ...
        ("p", ""),
        ("h3", "Video Scaler"),
        ("p", "Batch resize video files (Tools \u2192 Video Scaler, Ctrl+Shift+R). Also available as docflix-scale standalone command."),
        ("p", ""),
    ...
    ("Keyboard Shortcuts", [
        ...
        ("table_row", "Ctrl+Shift+R|Video Scaler"),
    ...
    ("Preferences", [
        ...
        ("bullet", "Video Scaler settings (resolution, encoder, preset, CRF, output folder)"),
        ("p", ""),
