...
**Last Updated:** 2026-05-09 (rev 60)  
**Version:** 2.9.2  
...
| `tv_renamer.py` | 2,133 | File Renamer — TVDB/TMDB API, multi-episode, folder templates, custom templates, TVDB/TMDB ID variables, undo, threaded loading, disambiguation; multi-separator subtitle tag detection; already-named files cleared from list |
...
### 2026-05-09 (v2.9.2 — File Renamer Title Matching, Thumbnail Fix)
